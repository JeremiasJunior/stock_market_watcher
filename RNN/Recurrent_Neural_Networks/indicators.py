...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 11 16:35:22 2020
...
inputs = stock_clean[len(stock_clean) - 250 - 60:].values
'''
...
y_test = dataset[len(dataset) - 60:, 3]
...
plt.title('MSTF Stock Price Prediction')
plt.xlabel('Time')
